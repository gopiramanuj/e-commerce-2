    ...
    <div class="card is-clearfix columns">
        ...
        <div class="card-content column is-two-thirds">
          ...
          <div class="card-content__text">
            <p>
            Material/Fabric :95% Polyester, 5% </br>
            ElastaneSize & Fit :
            This brand runs true to size. To ensure the best fit, we suggest consulting the size chart.</br></br>
...
<style lang="scss" scoped>
  ...
  figure.card-image.is-480x480.column.is-one-thirds {
  height: 400px;
  }
  .card-content {
